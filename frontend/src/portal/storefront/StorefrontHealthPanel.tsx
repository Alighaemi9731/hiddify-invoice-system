...
const ERROR_LABELS: Record<string, string> = {
  ...
  network: "ارتباط با سرویس برقرار نیست — معمولاً به‌صورتِ خودکار برطرف می‌شود",
        ...
        <Stack spacing={2}>
          {healthy ? (
            ...
            <Alert severity="warning" icon={<WarningAmberIcon />}>
              {!open
                ? "فروشگاه شما بسته است؛ مشتری‌ها نمی‌توانند خرید کنند. می‌توانید آن را از بخشِ «تنظیمات» باز کنید."
                : !botLive
                  ? (errorClass ? ERROR_LABELS[errorClass] : "ربات فروشگاه فعال نیست.")
                  : "اختلالی در سرویس‌دهی وجود دارد و در حال بررسی است؛ معمولاً به‌صورتِ خودکار برطرف می‌شود."}
            </Alert>
          )}
