...
const MY_SHOP: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { t: "گزارشِ مالی", d: "در تبِ «گزارش مالی»: چند گیگ فروخته‌اید، آن گیگ در فاکتورِ خودتان چقدر حساب می‌شود، رباتتان چقدر دریافت کرده و سودتان چقدر شده — ماه‌به‌ماه یا مجموعِ همهٔ ماه‌ها." },
    ],
  },
  {
