...
const SECTIONS: { icon: ReactNode; color: string; title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "برای پرداخت، روی «پرداخت» بزنید و طبقِ راهنمای پرداخت (USDT/TON/کارت) عمل کنید.",
    ],
  },
  {
    ...
    body: [
      ...
      "برای USDT/TON «شناسهٔ تراکنش (TXID)» و برای کارت «تصویرِ رسید» را در دیالوگِ پرداخت بفرستید.",
