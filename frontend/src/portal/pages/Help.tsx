...
const MY_SHOP: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { t: "یادآوریِ خودکار", d: "ربات خودش نزدیکِ انقضا، پس از پایانِ تست، در مصرفِ زیادِ حجم و پس از منقضی‌شدن به مشتری یادآوری می‌کند." },
    ],
  },
];
...
function HelpSection({ s }: { s: Section }) {
  return (
    <Accordion
      ...
      sx={{ mb: 1, borderRadius: 3, "&:before": { display: "none" }, overflow: "hidden" }}
    >
