    ...
    subs: [
      {
        fields: [
          ...
          { key: "enforcement_action_batch_limit", label: "تعداد نماینده در هر دورِ مسدودسازی", type: "number", min: 1, max: 20, advanced: true,
            help: "کارگرِ مسدودسازی در هر اجرا حداکثر این تعداد نماینده را پردازش می‌کند. مقدار کم = اجرای ملایم‌تر و امن‌تر روی پنل (مسدودسازیِ گروهی یک‌باره فشار نمی‌آورد). پیش‌فرض ۱." },
