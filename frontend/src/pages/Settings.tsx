    ...
    subs: [
      {
        fields: [
          ...
          { key: "overage_tolerance_gb", label: "اغماض مصرف اضافه (گیگ)", help: "سرریزِ کوچکِ هر کاربر تا این مقدار نادیده گرفته می‌شود (xray چند دقیقه بعد از پُرشدنِ حجم لیت قطع می‌کند و چند صد مگ بیشتر مصرف می‌شود — این سوءاستفاده نیست). ریستِ واقعی چندین گیگ است و همچنان محاسبه می‌شود. پیش‌فرض ۰٫۵", type: "number", min: 0, when: (v) => !!v("metering_enabled") },
