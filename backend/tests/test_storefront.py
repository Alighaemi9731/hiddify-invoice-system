...
# The shop broadcast fan-out moved to the durable delivery worker in plan 006 (v1.87.0); the flood
# control + retry ladder is now covered by tests/test_portal_storefront_communications.py.
