...
- نتیجهٔ Release: ادغام در `main`، انتشار v1.82.3 و smoke-check تولید
  (برنامهٔ اجراییِ تفصیلی در تاریخچهٔ Git بایگانی شده است)
...
- وضعیت: DONE — همهٔ شش Release (A تا F) منتشر و روی تولید مستقر شدند: A `v1.83.0/.1`،
  ...
  F `v1.88.0` (پَریتی ربات/پورتال، deep-link امن، خانهٔ فشردهٔ مالک). مرزهای باقی‌مانده:
  دسترسی وب هم‌ادمین‌ها (مورد ۱۵)، CRM (مورد ۱۴)، حسابداری (مورد ۱۲).
- برنامه‌های اجراییِ تفصیلیِ شش Release در تاریخچهٔ Git بایگانی شده‌اند.
