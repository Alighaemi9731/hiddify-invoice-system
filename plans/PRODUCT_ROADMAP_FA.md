...
| PLANNED | برنامهٔ اجرایی دقیق آن نوشته و تأیید شده |
...
| ۲ | ساخت کاربر از داخل پورتال نماینده | M | متوسط | احتمالاً خیر | CANDIDATE |
| ۳ | مرکز کامل مدیریت فروشگاه در پورتال | XL | متوسط/زیاد | بله | CANDIDATE |
| ۴ | فاکتور و وصول مطالبات نماینده از زیرمجموعه‌ها | XL | زیاد | بله | CANDIDATE |
| ۵ | بازطراحی کامل منوی ربات‌ها | M | متوسط | خیر | CANDIDATE |
...
### تقسیم پیشنهادی Release

- مرحله A: dashboard و view-only
- مرحله B: پلن‌ها و تنظیمات
- مرحله C: مشتریان و wallet actions
- مرحله D: پرداخت‌ها و credit codes
- مرحله E: campaign، سود و گزارش پیشرفته
...
- [ ] هر قابلیت روزمرهٔ admin bot معادل وب داشته باشد.
- [ ] ربات پس از انتقال، اعلان و shortcut باقی بماند.
- [ ] service layer مشترک باشد.
- [ ] هیچ mutation فقط با check سمت frontend محافظت نشود.
- [ ] wallet و panel action دقیقاً یک‌بار اجرا شوند.
- [ ] هر مرحله جداگانه قابل Release و rollback باشد.
